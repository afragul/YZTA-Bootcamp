...
class LearningPathService:
    ...
    def _build_system_instruction(self) -> str:
        ...
        return (
            ...
            "   'resource_type' KESIN kural: metinde 'YouTube' geciyorsa -> 'video'. "
            "'kitap' geciyorsa -> 'kitap'. Coursera/Udemy/Microsoft Learn/Skill Builder gibi "
            "yapilandirilmis egitim -> 'kurs'. Resmi dokuman/rehber -> 'dokumantasyon'. "
            "Adayin ELIYLE URETECEGI cikti -> 'proje'. Alistirma/pratik cozmek PROJE DEGILDIR. \n"
            "   HER 'resource_suggestion' alaninda TEK bir kaynak olsun. Iki kaynagi 've' ile "
            "birlestirme (tipleri farkli olur).\n"
